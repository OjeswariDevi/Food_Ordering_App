      ...
      {/* user navbar */}
        ...
        {!usertype ?
            ...
            <div className="navbar">
              <h3 onClick={()=> navigate('')}>CraveKart</h3>
                ...
                <div className="navbar">
                  ...
                  <div className="nav-content">
                    <div className="nav-search">
                      ...
                      {
                        noResult === true ?
                          <div className='search-result-data'>no items found.... try searching for Biryani, Pizza, etc., <ImCancelCircle className='search-result-data-close-btn' onClick={()=> setNoResult(false)}  /></div>
                        :
                        ""
                      }
                    </div>
                    ...
                    <div className='nav-content-icons' >
                      <div className="nav-special" onClick={()=> navigate('/special-items')}>
                        🍳 Specials
                      </div>
            ...
            <>
              {usertype === 'admin' ? 
                <div className="navbar-admin">
                  <h3 onClick={()=> navigate('/admin')}>CraveKart (admin)</h3>
                ...
                <>
                  {usertype === 'restaurant' ? 
                    <div className="navbar-admin">
                      <h3 onClick={()=> navigate('/restaurant')}>CraveKart (Restaurant)</h3>
